...
class JoystickWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        p.drawEllipse(cx - self.radius+16, cy - self.radius+16,
                      (self.radius-16)*2, (self.radius-16)*2)
    ...
    def update_knob(self, mouse_pos):
        ...
        if   angle_deg < 22.5  or angle_deg >= 337.5:  cmd = "R"
        elif angle_deg < 67.5:                        cmd = "RB"
        elif angle_deg < 112.5:                       cmd = "B"
        elif angle_deg < 157.5:                       cmd = "LB"
        elif angle_deg < 202.5:                       cmd = "L"
        elif angle_deg < 247.5:                       cmd = "LF"
        elif angle_deg < 292.5:                       cmd = "F"
        else:                                         cmd = "RF"
